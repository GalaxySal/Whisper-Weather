...
function WeatherExplorer() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-white border border-white/20">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h1 className="text-3xl font-bold">{t("weatherExplorer")}</h1>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 text-white border border-white/20">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-2xl font-bold">
                  {weatherStats.totalSearches}
                </span>
              </div>
              <h3 className="text-lg font-semibold">{t("totalSearches")}</h3>
              <p className="text-sm text-white/60">
                {weatherStats.todaySearches} {t("today")}
              </p>
            </div>
      ...
      {selectedTab === "history" && (
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 text-white border border-white/20">
          <h3 className="text-xl font-semibold mb-6">{t("searchHistory")}</h3>
      ...
      {selectedTab === "cities" && (
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 text-white border border-white/20">
          <h3 className="text-xl font-semibold mb-6">{t("cityStatistics")}</h3>
      ...
      {selectedTab === "trends" && (
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 text-white border border-white/20">
          <h3 className="text-xl font-semibold mb-6">{t("searchTrends")}</h3>
            ...
            <div className="bg-white/5 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {searchHistory.length > 0 &&
                    searchHistory.some((s) => s.temperature)
                      ? Math.round(
                          searchHistory
                            .filter((s) => s.temperature)
                            .reduce((acc, s) => acc + (s.temperature || 0), 0) /
                            searchHistory.filter((s) => s.temperature).length,
                        )
                      : "N/A"}
                    °C
                  </span>
