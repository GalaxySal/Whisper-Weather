...
export default function App() {
  ...
  console.log(`App running on: ${isTauri() ? 'Tauri Desktop' : 'Web Browser'}, Language: ${language}`)
  ...
  return (
    <div className={`flex min-h-screen bg-gradient-to-br ${getWeatherGradient()}`}>
      {/* Sidebar */}
      <div className="w-16 bg-white/10 backdrop-blur-md border-r border-white/20">
        <AppSidebar currentPage={currentPage} onPageChange={(page: Page) => setCurrentPage(page)} />
      </div>
